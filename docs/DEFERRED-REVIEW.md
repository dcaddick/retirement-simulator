...
| AIPR-003-OTHERINC-SPLIT | Deferred | Other taxable income is split equally between the two people. | Can understate tax when income belongs mainly to one partner. | Adding ownership changes persisted data and interface controls. | Accounting, tax and migration design. | Specify an owner field and schema migration. |
