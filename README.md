...
Unreleased v0.8 work uses native schema 5 and adds salary-growth parity and Other-income parity. Imported above-inflation salary growth now feeds salary, SG, tax, Age Pension assessment and household funding in every path. Other income now retains currency conversion, CPI indexation, taxable treatment, ownership and survivor continuation. Monte Carlo remains experimental, and issue #1 stays open while the Other assets, pension, lump-sum and share-return guards remain.
